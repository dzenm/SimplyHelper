...
import com.dzenm.example.databinding.FragmentHomeBinding;
...
public class HomeFragment extends AbsBaseFragment<MainActivity> implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DrawableHelper.radius(8).pressed(android.R.color.holo_blue_bright, com.dzenm.helper.R.attr.divideColor).into(binding.tv100);
        DrawableHelper.radius(8).ripple(android.R.color.holo_blue_light, com.dzenm.helper.R.attr.divideColor).into(binding.tv101);
        DrawableHelper.radius(8).pressed(android.R.color.holo_orange_light, com.dzenm.helper.R.attr.divideColor).into(binding.tv102);
        DrawableHelper.radius(8).ripple(android.R.color.holo_green_light, com.dzenm.helper.R.attr.divideColor).into(binding.tv103);
        DrawableHelper.radius(8).pressed(android.R.color.holo_purple, com.dzenm.helper.R.attr.divideColor).into(binding.tv104);
        DrawableHelper.radius(8).ripple(android.R.color.holo_blue_bright, com.dzenm.helper.R.attr.divideColor).into(binding.tv105);
        DrawableHelper.radius(8).pressed(android.R.color.holo_orange_dark, com.dzenm.helper.R.attr.divideColor).into(binding.tv106);
        DrawableHelper.radius(8).pressed(android.R.color.holo_blue_dark, com.dzenm.helper.R.attr.divideColor).into(binding.tv107);
        DrawableHelper.radius(8).pressed(android.R.color.holo_orange_light, com.dzenm.helper.R.attr.divideColor).into(binding.tv108);
...
//            startActivity(intent);
            ...
            startActivity(intent);
        } else if (view.getId() == com.dzenm.helper.R.id.tv_106) {
            Intent intent = new Intent(getActivity(), MaterialActivity.class);
            startActivity(intent);
        } else if (view.getId() == com.dzenm.helper.R.id.tv_107) {
            Intent intent = new Intent(getActivity(), PhotoSelectorActivity.class);
            startActivity(intent);
        } else if (view.getId() == com.dzenm.helper.R.id.tv_108) {
