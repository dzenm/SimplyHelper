...
import com.dzenm.helper.view.EditTextVerifyHelper;
...
public class LoginDialog extends AbsDialogFragment implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        // 校验多个EditText是否输入了文本
        mEditTextVerifyHelper.addView(etUsername, etPassword, etVerifyCode)
                .verify(true);
    }
    ...
    public void onClick(View view) {
        if (onClickListener != null) {
            if (view.getId() == R.id.tv_confirm) {             // 确认按钮
                ...
                if (mEditTextVerifyHelper.verify(false)) {
