package com.dzenm.helper.drawable;
...
public class DrawableHelper {
     ...
     * @return ShapeHelper
     */
    public static ShapeHelper alpha(int alpha) {
        return ShapeHelper.getInstance().solid(alpha);
    }
     ...
     * @return ShapeHelper
     */
    public static ShapeHelper state(@ShapeHelper.SelectorState int state, Drawable normalDrawable, Drawable pressedDrawable) {
